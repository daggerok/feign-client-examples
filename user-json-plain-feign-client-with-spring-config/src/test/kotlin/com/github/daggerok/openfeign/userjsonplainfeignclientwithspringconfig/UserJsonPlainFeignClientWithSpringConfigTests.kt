...
internal class UserJsonPlainFeignClientWithSpringConfigTestsApp

@TestInstance(PER_CLASS)
@AutoConfigureWireMock //(port = 0)
@SpringBootTest(webEnvironment = RANDOM_PORT)
@DisplayNameGeneration(ReplaceUnderscores::class)
@DisplayName("User json plain openfeign client with spring config tests")
@ContextConfiguration(classes = [UserJsonPlainFeignClientWithSpringConfigTestsApp::class])
class UserJsonPlainFeignClientWithSpringConfigTests @Autowired constructor(
    val userJsonPlainFeignClientWithSpringConfig: UserJsonPlainFeignClientWithSpringConfig,
    ...
    fun `should create user`() {
        ...
        // when
        val document = userJsonPlainFeignClientWithSpringConfig.createUser(createUserCommand)
    ...
    fun `should get users by age 38`() {
        ...
        // when
        val document = userJsonPlainFeignClientWithSpringConfig.getUsersByAge(38)

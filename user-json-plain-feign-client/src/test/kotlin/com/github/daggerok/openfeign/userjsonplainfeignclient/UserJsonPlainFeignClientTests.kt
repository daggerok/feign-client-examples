package com.github.daggerok.openfeign.userjsonplainfeignclient
...
internal class UserJsonPlainFeignClientTestsApp

@TestInstance(PER_CLASS)
@AutoConfigureWireMock //(port = 0)
@SpringBootTest(webEnvironment = RANDOM_PORT)
@DisplayNameGeneration(ReplaceUnderscores::class)
@DisplayName("User json plain openfeign client tests")
@ContextConfiguration(classes = [UserJsonPlainFeignClientTestsApp::class])
class UserJsonPlainFeignClientTests @Autowired constructor(
    val userJsonPlainFeignClient: UserJsonPlainFeignClient,
    ...
    fun `should create user`() {
        ...
        // when
        val document = userJsonPlainFeignClient.createUser(createUserCommand)
    ...
    fun `should get users by age 38`() {
        ...
        // when
        val document = userJsonPlainFeignClient.getUsersByAge(38)
